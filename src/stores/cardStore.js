  ...
  () => {
    ...
    const loadCards = async (params = {}) => {
      ...
      try {
        ...
        error.value = getErrorMessage(requestError, '보유카드 목록을 불러오지 못했습니다.');
        throw requestError;
      } finally {
        loading.value = false;
      }
    ...
    const loadMonthlyStatuses = async (params = {}) => {
      ...
      try {
        ...
        error.value = getErrorMessage(requestError, '카드 현황을 불러오지 못했습니다.');
        throw requestError;
      } finally {
        loading.value = false;
      }
    ...
    const loadPoints = async () => {
      ...
      try {
        ...
        error.value = getErrorMessage(requestError, '포인트를 불러오지 못했습니다.');
        throw requestError;
      } finally {
        loading.value = false;
      }
    ...
    const loadMemberships = async () => {
      ...
      try {
        ...
        error.value = getErrorMessage(requestError, '멤버십을 불러오지 못했습니다.');
        throw requestError;
      } finally {
        loading.value = false;
      }
