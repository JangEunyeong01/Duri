...
<div class="notification-view">
  ...
  <PageHeader title="알림" @back="goBack">
    <button @click="readAll" style="background: var(--color-primary); color: var(--color-btn-primary-text); border: none; padding: var(--space-sm) var(--space-lg); border-radius: var(--radius-lg); font-weight: 600; font-size: var(--font-sm); cursor: pointer; height: 40px; display: flex; align-items: center;">
      모두 읽음
    </button>
  </PageHeader>
